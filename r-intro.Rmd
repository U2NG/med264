...
* data download https://raw.githubusercontent.com/resbaz/r-novice-gapminder-files/master/data/gapminder-FiveYearData.csv
* Day 1 command history - https://dl.dropboxusercontent.com/u/11326940/r-gps/r-gps-day1.R
...
* useful commands for working with R session 
* `ls()` shows R ojects
* `ls` plain will print out code for that function (or any R function)
* Remove objects use `rm(x)`
* **TIP**: If you have a lot of objects and want to delete all, use rm(list=ls()) - useful for startin afresh, often you will see this in the top of R scripts. 
...
* Create project in RStudio called med264-r 
* Create a data/ folder inside
...
* AKA 'atomic vectors' because they can only contain **one** data type
